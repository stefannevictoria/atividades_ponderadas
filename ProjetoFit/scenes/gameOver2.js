export class GameOverScene2 extends Phaser.Scene {
    ...
    preload () {
        ...
        this.load.image('perdeu', 'assets/textos/perdeu.png');
    ...
    create () {
        ...
        this.add.image(this.larguraJogo/2, 120, 'perdeu').setScale(0.6);
